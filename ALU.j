...
.var 9 is result F
	...
	fstore	9
;
; 034 floatoper1,oper2
;
;
; 035 intint_oper1,int_oper2
;
;
; 036 intfact_n
;
...
;
	...
	fstore	7
;
; 040 println("2.25 + 4 * (1 + 3.0 / 2) = ",op)
;
	getstatic	java/lang/System/out Ljava/io/PrintStream;
	ldc	"2.25 + 4 * (1 + 3.0 / 2) = %f\n"
	iconst_1
...
L020:
;
; 075 floatresult=ALU(oper1,oper2,operation)
;
	fload_0
	fload_1
	iload	5
	...
	fstore	9
;
; 076 println(oper1:2:2," ",expr," ",oper2:2:2," = ",result:2:2)
;
	getstatic	java/lang/System/out Ljava/io/PrintStream;
