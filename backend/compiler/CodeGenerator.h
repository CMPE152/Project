 ...
 */
#ifndef ASMCOMPILER_CODEGENERATOR_H_
#define ASMCOMPILER_CODEGENERATOR_H_
...
#include "backend/compiler/LocalVariables.h"
#include "backend/compiler/LocalStack.h"
...
public:
     ...
     */
    CodeGenerator(string programName, string suffix, Compiler *compiler, string outputDir="")
     ...
     * @param compiler the compiler to use.
     */
    CodeGenerator(CodeGenerator *parent, Compiler *compiler,string outputDir="")
     ...
     */
    void emitComment(XParser::StatementContext *ctx);
